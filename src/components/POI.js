  ...
  const addPOIs = () => {
    ...
    markerData.forEach((markerPoint) => {
      ...
      arr.push(
        ...
        >
          {(() => {
            // In single day view, show all POIs but with different styling:
            // - Current day POIs: full details (name, day, altitude) in larger font
            // - Other POIs: just name in smaller font (no D#, no altitude)
            ...
            const isOtherDayInSingleView = isSingleDayView && !isCurrentDayPOI;
