...
const Info = (props) => {
  ...
  return (
    <>
      {showInfo && (
        <div
          className={`info-overlay info-overlay--${isDesktop ? "desktop" : "mobile"}`}
        ...
        >
          ...
          <div
            className={`info-card info-card--${isDesktop ? "desktop" : "mobile"}`}
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <p style={{ marginTop: 0, marginBottom: "16px" }}>
                    This is a map-blog I designed and built to document the
                    incredible Everest Base Camp 3 Pass Trek my friend{" "}
                    <a
                    ...
                    and I completed in May 2016. Thanks to my friend{" "}
                    <a
                      href="https://www.8kexpeditions.com"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="info-link"
                      onClick={() =>
