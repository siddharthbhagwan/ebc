...
### Fixed
- **Lobuche Big Circle Bug**: Removed duplicate Point feature rendering from GeoJsonRoutes.js that caused a "big circle" marker at Lobuche on rest days (POI.js already handles all marker rendering)
